<template>
	<div class="output">
		...
		<p>
			<a
				href="https://www.change.org/p/national-action-against-police-brutality-and-murder"
			>National Action Against Police Brutality and Murder</a>,
			<a
				href="https://act.colorofchange.org/sign/state-emergency-black-people-are-dying?source=coc_main_website"
			>End the War on Black People</a>,
			<a href="https://peoplesbudgetla.com/">LA City Council: Defund the Police</a>,
			<a
				href="https://secure.everyaction.com/eR7GA7oz70GL8doBq19LrA2"
