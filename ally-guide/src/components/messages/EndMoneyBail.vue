<template>
 ...
 <p>In the current climate as we request the justice system be reevaluated, the least we can do is drop cash bail systems while we protest for our right to organize and demand change.
        ...
        <p> Tear gas has always been an inhumane method of dispersing protestors and controlling crowds and is an egregious attack on civil liberties and the right to peaceful assembly. However, the use of tear gas--which not only affects the nervous system, but also the pulmonary system-- is especially heinous during the time of a pandemic that weakens lung capacity and strength. Not only has this harmed protestors directly, many have had to remove their PPE (including face masks) to find relief from tear gas, leaving them completely exposed to COVID-19 and other pathogens. Free testing and treatment should be allocated to all. </p> <br>
        <p>Sincerely, </p>
